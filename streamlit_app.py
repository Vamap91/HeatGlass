...
Avalie o impacto com base nos seguintes critérios:
• Se o cliente demonstrou insatisfação, frustração ou ameaça de cancelamento → o impacto deve ser inferior a 50%.
• Se o cliente relatou problemas anteriores com a empresa → penalize o percentual.
• Se o cliente finalizou satisfeito, confiante e com boa expectativa → o impacto pode ser maior.
• Só atribua 100% se houver clareza de satisfação total por parte do cliente no encerramento da ligação.
